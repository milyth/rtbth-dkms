...
#define MAX_FIRMWAREIMAGE_LENGTH \
	(LOW_PROGRAM_MEMORY_SIZE + HI_PROGRAM_MEMORY_SIZE)
...
#define BUSY 1
#define IDLE 0
#define MAX_BUSY_COUNT \
	100 // Number of retry before failing access BBP & RF indirect register
...
#define MIN_SNIFF_LINK_PRIO_HIGH \
	32 /* Sniff threshold to escalate the link priority */
...
#define CSR_HIGH_LINK_SCH_MASTER_T_SERVE \
	4 /* Workaround for iPhone 3G(CSR): iPhone plays A2DP and inquiry */
#define CSR_HIGH_LINK_SCH_MASTER_T_HOLD \
	1 /* Workaround for iPhone 3G(CSR): iPhone plays A2DP and inquiry */
#define CSR_HIGH_LINK_SCH_MASTER_WEIGHT \
	1 /* Workaround for iPhone 3G(CSR): iPhone plays A2DP and inquiry */
...
#define DFLT_LINK_SCH_SLAVE_T_HOLD \
	21 /* Workaround for SCO(Slave) and FTP(Master) */
#define DFLT_LINK_SCH_SLAVE_WEIGHT 0

#define HIGH_LINK_SCH_SLAVE_T_SERVE 30
#define HIGH_LINK_SCH_SLAVE_T_HOLD \
	21 /* Workaround for SCO(Slave) and FTP(Master) */
#define HIGH_LINK_SCH_SLAVE_WEIGHT 1

#define MIN_LINK_SCH_SLAVE_T_SERVE 80
#define MIN_LINK_SCH_SLAVE_T_HOLD \
	41 /* Workaround for SCO(Slave) and FTP(Master) */
...
#define CSR_HIGH_LINK_SCH_MASTER_UPPER_T_VAL \
	4 /* Workaround for iPhone 3G(CSR): iPhone plays A2DP and inquiry */
#define CSR_HIGH_LINK_SCH_MASTER_LOWER_T_VAL \
	4 /* Workaround for iPhone 3G(CSR): iPhone plays A2DP and inquiry */
#define CSR_HIGH_LINK_SCH_MASTER_H_VAL \
	2 /* Workaround for iPhone 3G(CSR): iPhone plays A2DP and inquiry */
#define CSR_HIGH_LINK_SCH_MASTER_E_VAL \
	1 /* Workaround for iPhone 3G(CSR): iPhone plays A2DP and inquiry */
